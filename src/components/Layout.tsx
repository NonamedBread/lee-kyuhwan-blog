...
export default function Layout({ children }: Props) {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setShowHeader(currentScrollPos < scrollPos || currentScrollPos < 50);
  ...
  //TODO : 첫 스크롤시 스크롤 위로 올라가는 문제 showHeader 조건문 수정 필요, HomeHeader fixed됐을때 배경색 변경 필요, slide up 효과 추가
